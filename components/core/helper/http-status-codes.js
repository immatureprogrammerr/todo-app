...
messageCodes[exports.OK = 200] = "Module `%s` has been received";
messageCodes[exports.NOT_FOUND = 404] = "API not found";
...
messageCodes[exports.DB_TABLE_DUMPED_FAILURE = 608] = "Database tables dump\
 failed";
messageCodes[exports.INTERNAL_SERVER_ERROR = 609] = "There is an Internal server error";
...
messageCodes[exports.ALERT_CREATED = 612] = "Alert %s successfully";
...
messageCodes[exports.CONTENT_FOUND = 632] = "Content Found";


messageCodes[exports.INVALID_PARAMETERS = 631] = "Invalid Parameters";

messageCodes[exports.SUCCESS = 632] = "Deleted Successfully";
messageCodes[exports.FAILURE = 633] = "An error occur while deleting";
